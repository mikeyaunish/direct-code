...
text-undoer: context [
    ...
    run-actions: function [
        {Run the redo operations by default - gathered from the compare-text f-unction}
        action-block [block!]
        input [string!]
    ...
    find-end-diff: function [
        ...
        while [test-word: pick-word a word-num] [
            either b-fnd: find/case b test-word [
