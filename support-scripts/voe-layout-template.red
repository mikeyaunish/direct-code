...
style anti-alias-drop-dwn: drop-down font-size voe-anti-alias-drop-down-font-size voe-anti-alias-drop-down-size 
...
tab-panel1~: tab-panel [
    "Object" [
        ...
        on-over [] extra [original-color: none] 
        on-up [
            voe-menu-handler name-field~/text "highlight-source-object"
        ] 
        on-create [
            convert-to-button target-object-label~
        ] 
        ...
        edit-style-button~: button edit-icon-image voe-import-icon-size [
            if all [(style-field~/text <> "<none>") (not stock-style? style-field~/text)] [
    ...
    "Appearance" [
        ...
        para-h-align-zero-btn~: zero-btn [
        ...
        para-v-align-zero-btn~: zero-btn [
    ...
    "Font" [
        ...
        space 4x4 return 
        font-anti-alias?-label~: base font-size voe-font-size voe-label-size right 230.230.230 black 
        on-over [] extra [original-color: none] "Anti-Alias?:" [highlight-field-source~ face] 
        font-anti-alias?-drop-down~: anti-alias-drop-dwn data ["true" "false" "'ClearType" "<omit>"] 
        on-change [
        ...
        font-anti-alias?-zero-btn~: zero-btn on-click [
    ...
    "Actions" [
        ...
        button "Create Any Action" bold font-size 12 102.168.152.0 center green 61.174.71.0 [
            if (picked: request-list/size/one-click "Pick an action.<one-click>" dc-actor-list 300x300) [
    ...
    disable-unneeded-facets: function [
        ...
        unneeded-facets: [
            ...
            panel [tri-state password halign valign wrap no-border hint font-name font-size font-color bold italic underline strike anti-alias? image draw-block select true-false date percent default-string] 
            ...
            tab-panel [tri-state password halign valign wrap no-border hint font-name font-size font-color bold italic underline strike anti-alias? image draw-block select true-false date percent default-string] 
    ...
    source-to-view-fields: function [
        ...
        object-data/type: reduce [object-type] 
