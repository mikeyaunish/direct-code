Red [
	Title: "inputting-integer-saved-label-inline-scenario.red"
	Needs: View
...
inputting-integer-saved-label-inline-scenario-layout: [
            ...
            setup-style: [
                [
                    input [
                    	...
                    	detail {Name of of the field to be created. This name is used to save the field data as well. File name format is: <field-name>.data IE: "first-name-field.data" }
                    ]
                    action [
...
do show-window: [
	view inputting-integer-saved-label-inline-scenario-layout
]
