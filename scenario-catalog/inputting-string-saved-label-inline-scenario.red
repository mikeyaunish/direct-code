Red [
	Title: "inputting-string-saved-label-inline-scenario.red"
	Needs: View
...
inputting-string-saved-label-inline-scenario-layout: [
...
do show-window: [
	view inputting-string-saved-label-inline-scenario-layout
]
