Red [
	Title: "button-x-axis-left-style.red"
	Needs: View
...
button-x-axis-left-style-layout: [
	...
	f1: field "field1"
	button-x-axis-left1: button-x-axis-left with [extra/output-field: 'f1]
]

;Direct Code Show Window source marker - DO NOT MODIFY THIS LINE OR THE NEXT LINE!
do show-window: [
	view button-x-axis-left-style-layout
]